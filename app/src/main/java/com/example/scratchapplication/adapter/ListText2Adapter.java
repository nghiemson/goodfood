...
public class ListText2Adapter extends RecyclerView.Adapter<ListText2Adapter.MyViewHolder> {
    List<String> listString;
    Context context;
    private List<Integer> drawableStepList;
    public ListText2Adapter(List<String> listString, Context context){
